document.addEventListener('DOMContentLoaded', () => {
    ...
    const renderNotes = () => {
        ...
        notes.forEach((note, index) => {
            ...
            noteItem.innerHTML = `
                <span>${note.text}</span>
                <div class="btn-group">
                    <button class="btn btn-info btn-sm share-note-btn" data-index="${index}">Share</button>
                    <button class="btn btn-danger btn-sm delete-note-btn" data-index="${index}">Delete</button>
                </div>
            `;
    ...
    noteList.addEventListener('click', (e) => {
        ...
        } else if (e.target.classList.contains('share-note-btn')) {
            shareNote(e.target.dataset.index);
        }
    });
